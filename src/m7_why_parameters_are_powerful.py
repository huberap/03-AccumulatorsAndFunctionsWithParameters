...
#     -- CHECK The amount by which the radii vary (as you did above)
#     -- CHECK The number of concentric circles drawn
#     -- The center of the concentric circles
#     -- CHECK The outline_color of the concentric circles
...
def run_test_even_better_draw_circles():
    ...
    print('Testing  better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(9,30,'red')


def even_better_draw_circles(R,Num,color):
    window = rg.RoseWindow(400, 400)
